...
<body>
    ...
    <div id = "airjordan-div">
        <img src = "images/airjordans.jpg" width = "275px" height = "400px" alt = "jordans">
    </div>
    ...
    <div id = "desertSandles-div">
        <img src = "images/desert-sandles.jpg" width = "275px" height = "400px" alt = "desertSandles">
    </div>
    ...
    <div id = "tacticalBoots-div">
        <img src = "images/tactical-boots.jpg" width = "265px" height = "265px" alt = "tacticalBoots">
    </div>
    ...
    <div id = "luxuryUggs-div">
        <img src = "images/luxury-uggs.jpg" width = "265px" height = "265px" alt = "luxuryUggs">
    </div>

    <figcaption id = "uggs-shoe-fig"> Embrace Fall & Winter with our comfy tailor made uggs </figcaption>
    </figure>
    
    <figure>
    <div id = "gucci-loafers-div">
        <img src ="images/gucci-loafers.jpg" width = "265px" height = "265px" alt = "gucci">
    </div>
    ...
    <div id = "yellow-yeazy-div">
        <img src ="images/yellow-yeezy.jpg" width = "275px" height = "400px" alt = "yeezy">
    </dvi>
